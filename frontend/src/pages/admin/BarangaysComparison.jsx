...
/* ─── print ─── */
function printReport(muni, fromDate, toDate, summary, brgyRows, insights, chartSvgs = {}) {
  const { a = '', b = '', c = '', d = '' } = chartSvgs
  ...
  w.document.write(`<!DOCTYPE html><html><head>
    ...
    <style>
      ...
      .chart-box{margin:12px 0;page-break-inside:avoid}
      .chart-title{font-size:10px;color:#555;text-transform:uppercase;letter-spacing:.05em;margin-bottom:4px;font-weight:bold}
    ...
    <div style="margin-top:20px">
      <h2 style="font-size:12px;color:#444;margin:16px 0 6px;text-transform:uppercase;letter-spacing:.05em">Visual Analytics</h2>
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px">
        ${a ? `<div class="chart-box"><div class="chart-title">A — Barangay Ranking</div>${a}</div>` : ''}
        ${b ? `<div class="chart-box"><div class="chart-title">B — Status Distribution</div>${b}</div>` : ''}
        ${c ? `<div class="chart-box" style="grid-column:1/-1"><div class="chart-title">C — SOS Trend</div>${c}</div>` : ''}
        ${d ? `<div class="chart-box" style="grid-column:1/-1"><div class="chart-title">D — Response Time vs Resolution Rate</div>${d}</div>` : ''}
      </div>
    </div>` : ''}
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <div className="flex gap-2">
              ...
              {hasData && (
                <button onClick={() => {
                  const chartSvgs = {
                    a: captureSvg(chartARef),
                    b: captureSvg(chartBRef),
                    c: captureSvg(chartCRef),
                    d: captureSvg(chartDRef),
                  }
                  printReport(muni, fromDate, toDate, summary, tableRows, insights, chartSvgs)
                }}
      ...
      {hasData && (<>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div ref={chartARef} className="glass rounded-xl p-4 border border-[rgba(255,255,255,0.06)]">
            ...
            {/* Chart B — Stacked Bar */}
            <div ref={chartBRef} className="glass rounded-xl p-4 border border-[rgba(255,255,255,0.06)]">
            ...
            <div ref={chartCRef} className="glass rounded-xl p-4 border border-[rgba(255,255,255,0.06)] lg:col-span-2">
            ...
            <div ref={chartDRef} className="glass rounded-xl p-4 border border-[rgba(255,255,255,0.06)] lg:col-span-2">
